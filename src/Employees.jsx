...
/* Employee Data */
const Employees = ({ employees, selectedTeam, handleEmployeeCardClick, handleTeamSelectChange }) => {
  return (
    <main className='container'>
      ...
      <div className='row justify-content-center mt-3 mb-3'>
        <div className='col-8'>
          <div className='card-collection justify-content-center mt-3 mb-3'>

            {/* go through the employee data and render each employee */}
            {
